...
PACKAGENAME = metadata.get('package_name', 'flarepy')
DESCRIPTION = metadata.get('description', 'My working code for solar flare detection.')
AUTHOR = metadata.get('author', 'Alex Hamilton')
