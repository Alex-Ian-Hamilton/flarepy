...
def modified_find_peaks_cwt(vector,
                            widths,
                            wavelet=None,
                            max_distances=None,
                            gap_thresh=None,
...
def modified_get_flare_peaks_cwt(ser_data,
    ...
    arr_peak_time_indices, cwt_dat, ridge_lines, filtered = modified_find_peaks_cwt(ser_data.values,
                                                                                    widths,
                                                                                    wavelet=wavelet,
