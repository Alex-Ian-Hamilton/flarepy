...
ser_xrsa_raw_int_60S_box5, ser_xrsa_plt_fil = utils.pre_process(ser_xrsa_raw, resample_bins=60*u.s, resample_method='median', average_method='mean', int_cart=5)
...
ser_xrsb_raw_int_60S_box5, ser_xrsb_plt_fil = utils.pre_process(ser_xrsb_raw, resample_bins=60*u.s, resample_method='median', average_method='mean', int_cart=5)
