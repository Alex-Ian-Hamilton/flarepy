...
def make_signal_axes_thumbnail(ax, signal, signal_x=None, peaks=None, log=True):
    """
    Make a simple line plot with peak crosses for the input signal.
    """
    global str_title
...
if __name__ == '__main__':
    ...
    ax_signal = plt.axes([0.05, 0.72, 0.9, 0.20])
    ax_cwt = plt.axes([0.05, 0.50, 0.9, 0.25])
    ax_signal_thumbnail = plt.axes([0.05, 0.40, 0.9, 0.05])
