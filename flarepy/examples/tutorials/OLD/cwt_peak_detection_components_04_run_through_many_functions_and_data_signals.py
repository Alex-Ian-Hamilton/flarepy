...
###############
# Basic function datasets
###########
for str_function, arr_data in dic_datasets.items():
    # Passing some details into the sub-functions
...
dic_dates = {'2014-03-29': ('2014-03-29 00:00:00', '2014-03-30 00:00:00'),
             ...
             '2003-11-04': ('2003-11-04 00:00:00', '2012-11-05 00:00:00'),
             '2001-04-02': ('2001-04-02 00:00:00', '2001-04-03 00:00:00'),
             '2003-10-28': ('2003-10-28 00:00:00', '2003-10-29 00:00:00')
             }

for str_date, tup_dates in dic_dates.items():
    # Passing some details into the sub-functions
    dic_details = { 'signal_name': str_date}
    ...
    # Get the peaks
    df_peaks_cwt, cwt_dat, ridge_lines, filtered = modified_get_flare_peaks_cwt(ser_xrsb_raw_int_60S_box5.interpolate(), widths=arr_cwt_widths, get_energies=False, alex=dic_details)
    ...
    # Add a title to the whole figure
    axarr[0].set_title('CWT Peak Detection Steps - GOES - '+str_start[0:10])
    ...
    # Save teh figure for viewing
    fig.savefig('CWT Peak Detection Steps - GOES - '+str_start[0:10]+'.png', dpi=900, bbox_inches='tight')